...
Since a variety of \caps{NMF} algorithms have been proposed, this problem is at least partially solved.
Here are some of the difficulties which remain:
\begin{itemize}
  ...
  \item \caps{NMF} is known to be \caps{NP}-hard; thus, all efficient algorithms are merely heuristic, and may or may not yield acceptable results in this setting.
\end{itemize}

% The problem of finding nonnegative factors for a given nonnegative matrix is known as nonnegative matrix factorization.

% This problem does not, in general, have a unique solution, so perfect recovery of $W$ and $P$ cannot, without further constraints, be achieved.
