...
\end{enumerate}
This meta-algorithm can recover $P$ very well, even when $Q$ is sampled with infinite variance, and when the prevalence constituent distributions is heavy tailed. Accurate recovery from sampled data is shown in Figure~6.
