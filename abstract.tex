...
Our motivating application is mixture modeling for traces of network flows, whose distributions of packet sizes and inter-packet intervals can be effectively modeled as discretized mixture models, using \caps{NMF}~\cite{Karpinski:2008}.
...
\end{center}
\vspace{-0.7em}
\caption{Transposed matrix plot of 200 sample random weights.}
\vspace{-0.5em}
\end{figure}
...
Our synthetic weight matrices are also generated such that the prevalences of the component distributions\,---\,i.e. the column sums of $W$---\,are Pareto-distributed. A matrix plot of 200 rows of randomly generated weights are shown in Figure~2 (transposed to save space).
